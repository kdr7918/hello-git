...
├── server-a/
│   ├── 20260101/
│   │   ├── cmd_20260101_090000_kim_1234.log
│   │   └── cmd_20260101_100000_lee_2345.log
│   └── 20260102/
│       └── cmd_20260102_110000_park_3456.log
└── server-b/
    └── 20260101/
        └── cmd_20260101_120000_choi_4567.log
```

각 `cmd_YYYYMMDD_HHMMSS_유저명_PID.log` 파일의 **4번째 줄만** 검사합니다.
...
- 파일명은 `cmd_YYYYMMDD_HHMMSS_유저명_PID.log` 형식이며 PID는 숫자여야 합니다.
- 마지막 `_PID.log` 앞의 유저명 부분을 집계하므로 유저명에 밑줄도 사용할 수 있습니다.
...
Python 3.6 이상이 필요하며 외부 패키지는 사용하지 않습니다.
